more details about the program can be found within the "files" directory, where there's a separate README text file describing the functionalities of the 2 programs.
